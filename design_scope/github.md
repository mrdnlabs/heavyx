...
repo: mrdnlabs/heavyx
branch: main

## Last sync
date: 2026-08-15T00:58:48Z

### Updated in this project
- Read current SteerX web UI, manifest params, steering config + STEERING.md to ground the redesign
- Built 3 live-page direction candidates (Console / Signal HUD / Field) with simulated DetectX data
