...
- `image-slot.js`, `support.js` — runtime helpers; keep next to the HTML files.
...
- Data shapes mirror the real endpoints (DetectX `status` detections, steerx params MarginPercent/OverlaySlot/LogMaxKB, VAPIX `center`/`areazoom` commands).
